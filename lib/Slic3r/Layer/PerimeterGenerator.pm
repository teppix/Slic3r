...
sub process {
    ...
    foreach my $surface (@{$self->slices}) {
        ...
        if (@gaps) {
            ...
            my @gap_sizes = (
                [ 1.8*$pwidth, 2.0*$pspacing, unscale 1.8*$pwidth ],
                [ 1.6*$pwidth, 1.8*$pwidth,   unscale 1.5*$pwidth ],
                [ 1.2*$pwidth, 1.6*$pwidth,   unscale 1.2*$pwidth ],
                [ 1.0*$pwidth, 1.2*$pwidth,   unscale 1.1*$pwidth ],
                [ 0.7*$pwidth, 1.0*$pwidth,   unscale 0.9*$pwidth ],
                [ 0.4*$pwidth, 0.7*$pwidth,   unscale 0.5*$pwidth ],
            );
